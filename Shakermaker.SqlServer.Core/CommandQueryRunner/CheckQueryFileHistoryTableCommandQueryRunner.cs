...
{
    public class CheckQueryFileHistoryTableCommandQueryRunner : BaseCommandQueryRunner
    {
        public CheckQueryFileHistoryTableCommandQueryRunner(DatabaseContext databaseContext) : base(databaseContext)
        {
        ...
        protected override string Command =>
            $@"
                ...
                AND TABLE_NAME = '{Constants.Table.QueryFileHistory}';
